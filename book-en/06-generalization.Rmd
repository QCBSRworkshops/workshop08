...
# GAM model checking {#gam-model-checking}
...
In [Chapter 5](#how-gams-work), we discussed the role of the smoothing parameter $\lambda$ in controlling the _wiggliness_ of our smoothing functions. This _wiggliness_ is further controlled by the basis dimension $k$, which sets the number of basis functions used to create a smooth function. 
...
```{r, out.width = '33%', echo = FALSE, fig.height = 8}

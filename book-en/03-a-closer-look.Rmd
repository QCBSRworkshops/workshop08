# A closer look at GAMs {#a-closer-look}
...
is too high then the data will be over smoothed, and if it is too low, the data will be under smoothed. Ideally, it is best to choose $\lambda$ so that the $predicted f$ is as close as possible to $f$. A suitable criterion might be to choose $\lambda$ to minimize:

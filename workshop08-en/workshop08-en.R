...
## ---- fig.height=4.3, fig.width=4.3, echo = FALSE-----------------------------
par(mar = c(4,4,0,0))
plot(prop_model)
...
## ---- echo = -1, fig.height=4, fig.width==4-----------------------------------
par(mar=c(3.8,4,0,0))
...
## ---- eval = FALSE, fig.width=9, fig.height=4.5-------------------------------
## par(mfrow = c(1,2))
## acf(resid(year_gam), lag.max = 36, main = "ACF")
## pacf(resid(year_gam), lag.max = 36, main = "pACF")


## ---- echo = F, fig.width=9, fig.height=4.5-----------------------------------
par(mfrow = c(1,2))
acf(resid(year_gam), lag.max = 36, main = "ACF")
pacf(resid(year_gam), lag.max = 36, main = "pACF")
...
## ---- fig.height=5, fig.width=5.5, echo = -1----------------------------------
par(mar=c(4,4,1,1))
...
## ---- echo = -1, fig.height=5.5, fig.width=5.5--------------------------------
